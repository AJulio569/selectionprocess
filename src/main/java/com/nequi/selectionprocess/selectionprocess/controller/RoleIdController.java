...
/**
 * RoleIdController es una clase controladora que maneja las solicitudes HTTP relacionadas con la entidad RoleId.
 * Está anotada con 
 * @RestController para indicar que es un componente de Spring que gestiona peticiones REST.
 * @RequestMapping ("/api/roles") define la ruta base para todas las solicitudes manejadas por esta clase.
...
public class RoleIdController {
     ...
     * @return un ResponseEntity con el rol si se encuentra, o un 404 Not Found si no se encuentra
     */
    @GetMapping("/{id}")
