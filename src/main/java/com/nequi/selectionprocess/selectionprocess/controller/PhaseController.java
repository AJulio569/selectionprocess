...
/**
 * OriginController es una clase controladora que maneja las solicitudes HTTP relacionadas con la entidad Phase.
 * Está anotada con 
 * @RestController para indicar que es un componente de Spring que gestiona peticiones REST.
 * @RequestMapping ("/api/phases") define la ruta base para todas las solicitudes manejadas por esta clase.
...
public class PhaseController {
     ...
     * @return un ResponseEntity con la fase si se encuentra, o un 404 Not Found si no se encuentra
     */
    @GetMapping("/{id}")
