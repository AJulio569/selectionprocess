...
/**
 * VacancyService es una clase de servicio que maneja la lógica de negocios relacionada con la entidad Vacancy.
 * Está anotada con 
...
public class VacancyService {
     ...
     * @return un Optional que contiene la vacante si se encuentra, o vacío si no se encuentra.
     */
